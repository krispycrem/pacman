...
from grid import binary_grid
from asciimaze import ascii_maze
from util import reverse_tuples
...
class Ghost(MovableObject):
    def __init__(self, in_surface, x, y, in_size: int, in_game_controller, ghost_chase_algorithm, sprite_path="images/ghost_fright.png"):
    ...
    def request_path_to_player(self, in_ghost):
        ...
        path = self.game_controller.p.get_path((current_maze_coord[1], current_maze_coord[0]), (player_position[1],
                                                player_position[0]), in_ghost.chase_algorithm)
...
class Pathfinder:
    ...
    def get_path(self, start, goal, chase_algorithm):
        ...
        cells = astarsearch.shortestPathBinaryMatrix(self.binar_grid, start, goal, chase_algorithm)
        ...
        reversed_cells = reverse_tuples(cells)
...
class PacmanGameController:
    def __init__(self):
        ...
        self.binar_grid = binary_grid
        self.p = Pathfinder(self.binar_grid)
